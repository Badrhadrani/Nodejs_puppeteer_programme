(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/http'), require('@angular/common'), require('rxjs'), require('rxjs/add/operator/map')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/http', '@angular/common', 'rxjs', 'rxjs/add/operator/map'], factory) :
	(factory((global['prestashop-api'] = global['prestashop-api'] || {}),global._angular_core,global._angular_http,global._angular_common,global.rxjs));
}(this, (function (exports,_angular_core,_angular_http,_angular_common,rxjs) { 'use strict';
...
var RequestService = (function () {
    ...
    RequestService.prototype.search = function (resource, params) {
        return this.request(this.resourceUrl(resource), _angular_http.RequestMethod.Get, params);
    };
    /**
     * @param {?} resource
     * @param {?} id
    ...
    RequestService.prototype.resource = function (resource, id, id_language) {
        ...
        return this.request(this.resourceUrl(resource, id), _angular_http.RequestMethod.Get, params);
    };
    /**
     * @param {?} url
     * @param {?} method
    ...
    RequestService.prototype.request = function (url, method, params, body) {
        ...
        return this.getRequest(url, method, params, _angular_http.ResponseContentType.Json, body);
    };
    /**
     * @param {?} data
     * @return {?}
    ...
    RequestService.prototype.apiConfigurationRequest = function (url, key) {
        ...
        return new _angular_http.Request({
            url: this.buildUrl([]),
            method: _angular_http.RequestMethod.Get,
    ...
    Object.defineProperty(RequestService.prototype, "headers", {
        ...
        get: function () {
            if (!this._headers) {
                this._headers = new _angular_http.Headers(this.getAuthHeaders(this._authData));
            }
            /*
            else {
...
var APIService = (function () {
    ...
    function APIService(http, requestService) {
        ...
        this.id_languageChange = new _angular_core.EventEmitter();
    ...
    APIService.prototype.getLanguages = function () {
        ...
        return rxjs.Observable.create(function (observer) {
            ...
            _this.http.request(_this.requestService.request(_this.requestService.resourceUrl(resource), _angular_http.RequestMethod.Get, params)).subscribe(function (response) {
                if (!response.ok) {
...
var AbstractService = (function () {
    ...
    AbstractService.prototype.get = function (id) {
        var _this = this;
        var /** @type {?} */ unallowed = this.checkConnectionAndMeyhodIsAllowed(_angular_http.RequestMethod.Get);
        if (unallowed)
            return unallowed;
    ...
    AbstractService.prototype.put = function (input) {
        return this.send(input, _angular_http.RequestMethod.Put);
    };
    /**
     * @param {?} input
     * @return {?}
    ...
    AbstractService.prototype.post = function (input) {
        return this.send(input, _angular_http.RequestMethod.Post);
    };
    /**
     * @param {?} id
     * @return {?}
    ...
    AbstractService.prototype.delete = function (id) {
        var /** @type {?} */ method = _angular_http.RequestMethod.Post;
    ...
    AbstractService.prototype.send = function (input, method) {
        ...
        return this.http.request(this.requestService.request(this.requestService.resourceUrl(this.resource), method, this.apiParameters, body)).map(function (response) {
            ...
            if (method == _angular_http.RequestMethod.Post) {
    ...
    AbstractService.prototype.serializeInstance = function (instance, method) {
        ...
        if (method == _angular_http.RequestMethod.Put)
            properties.push(ID);
...
exports.APIParametersNames = APIParametersNames;
exports.APIParametersValues = APIParametersValues;
exports.APIParameters = APIParameters;
exports.PrestashopApiModule = PrestashopApiModule;
exports.APIService = APIService;
exports.AbstractService = AbstractService;
exports.AddressService = AddressService;
exports.CarrierService = CarrierService;
exports.CartRuleService = CartRuleService;
...
exports.CustomerMessageService = CustomerMessageService;
exports.CustomerThreadService = CustomerThreadService;
...
exports.OrderCarrierService = OrderCarrierService;
exports.OrderDetailService = OrderDetailService;
exports.OrderCartRuleService = OrderCartRuleService;
exports.OrderHistoryService = OrderHistoryService;
exports.OrderInvoiceService = OrderInvoiceService;
exports.OrderPaymentService = OrderPaymentService;
exports.OrderSlipService = OrderSlipService;
exports.OrderStateService = OrderStateService;
exports.OrderService = OrderService;
exports.PriceRangeService = PriceRangeService;
exports.CustomizationFieldService = CustomizationFieldService;
exports.ProductFeatureValueService = ProductFeatureValueService;
exports.ProductFeatureService = ProductFeatureService;
exports.ProductOptionValueService = ProductOptionValueService;
exports.ProductOptionService = ProductOptionService;
exports.ProductSupplierService = ProductSupplierService;
exports.ProductService = ProductService;
exports.ShopGroupService = ShopGroupService;
exports.ShopUrlService = ShopUrlService;
exports.ShopService = ShopService;
exports.SpecificPriceRuleService = SpecificPriceRuleService;
exports.SpecificPriceService = SpecificPriceService;
exports.StateService = StateService;
exports.StockAvailableService = StockAvailableService;
exports.StockMovementReasonService = StockMovementReasonService;
exports.StockMvtService = StockMvtService;
exports.StockService = StockService;
exports.StoreService = StoreService;
exports.SupplierService = SupplierService;
exports.SupplyOrderDetailService = SupplyOrderDetailService;
exports.SupplyOrderHistoryService = SupplyOrderHistoryService;
exports.SupplyOrderReceiptHistoryService = SupplyOrderReceiptHistoryService;
exports.SupplyOrderStateService = SupplyOrderStateService;
exports.SupplyOrderService = SupplyOrderService;
exports.TagService = TagService;
exports.TaxRuleGroupService = TaxRuleGroupService;
exports.TaxRuleService = TaxRuleService;
exports.TaxService = TaxService;
exports.TranslatedConfigurationService = TranslatedConfigurationService;
exports.WarehouseProductLocationService = WarehouseProductLocationService;
exports.WarehouseService = WarehouseService;
exports.WeightRangeService = WeightRangeService;
